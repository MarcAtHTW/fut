...
def succesTradesFromWatchlist(coreobject, connection):
    ...
    assetIdList.clear()
    buyNowPriceList.clear()
    startingBidList.clear()
    contractList.clear()
    fitnessList.clear()
    timestampList.clear()
    tradeIdList.clear()
    ...
    offersList.clear()
    expiresList.clear()
    sellerEstablishedList.clear()
    tradeStateList.clear()
    bidStateList.clear()
    sellerIdList.clear()
    sellerNameList.clear()
    watchedList.clear()
    time_stampList.clear()
    ratingList.clear()
    ...
    formationList.clear()
    leagueIdList.clear()
    injuryTypeList.clear()
    injuryGamesList.clear()
    lastSalePriceList.clear()
    trainingList.clear()
    suspensionList.clear()
    pos_itionList.clear()
    playStyleList.clear()
    discardValueList.clear()
    itemTypeList.clear()
    cardTypeList.clear()
    cardsubtypeidList.clear()
    ownersList.clear()
    untradeableList.clear()
    moraleList.clear()
    ...
    teamidList.clear()
    assistsList.clear()
    lifetimeAssistsList.clear()
    loyaltyBonusList.clear()
    pileList.clear()
    nationList.clear()
    ye_arList.clear()
    resourceGameYearList.clear()
    cou_ntList.clear()
    untradeableCountList.clear()
